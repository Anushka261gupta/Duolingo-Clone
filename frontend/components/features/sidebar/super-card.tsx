...
export function SuperCard() {
  return (
    <div className="overflow-hidden rounded-2xl border-2 border-duo-purple/30 bg-duo-purple/5 p-5">
      ...
      <button className="w-full rounded-2xl bg-duo-purple px-4 py-3 text-sm font-extrabold uppercase tracking-wide text-white shadow-[0_4px_0_0_#a568cc] transition-transform active:translate-y-1 active:shadow-none">
        Try 2 weeks free
      </button>
    </div>
  )
